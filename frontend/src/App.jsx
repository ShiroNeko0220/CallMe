...
export default function App() {
  ...
  const login = (u) => {
    localStorage.setItem('callme_user', JSON.stringify(u))
    setUser(u)
    setSection('membres')
  }
  ...
  const logout = () => {
    localStorage.removeItem('callme_user')
    setUser(null)
    setSection('membres')
  }
      ...
      <div className="min-h-screen bg-gray-50 flex flex-col">
        ...
        <div className="flex flex-1">
          ...
          <main className="flex-1 p-6 min-w-0">
            ...
            {activeSection === 'profil'       && <MesInfosView     role={role} currentUser={user} onUserUpdated={updateUser} />}
          </main>
        </div>
