      ...
      {showForm && (
        <Card title="Créer une compétition">
          <div className="grid grid-cols-2 gap-x-4">
            ...
            <Input label="Durée en minutes" value={form.duree} onChange={e => f('duree', Number(e.target.value))} type="number" min="1" />
        ...
        >
          {showResForm && (
            <div className="mb-4 p-3 bg-gray-50 rounded-lg">
              ...
              <Input label="Numéro de l'enseignant" value={resForm.enseignantId} onChange={e => rf('enseignantId', e.target.value)} type="number" min="1" placeholder="ex. 3" />
              <div className="mb-3">
                <label className="block text-sm text-gray-600 mb-1">Note (0 à 10)</label>
