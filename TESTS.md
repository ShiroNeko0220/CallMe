...
| C-03 | Créer un cours | SECRETAIRE | Titre : Zumba niv1, Date : +8 jours, Heure : 10:00, Durée : 60, Lieu : Salle A, Enseignant : 3, Niveau : 1 | Cours créé et visible dans la liste |
| C-04 | Créer — enseignant non apte | SECRETAIRE | Même données, Enseignant : 3 (niv 3), Niveau : 5 | Erreur "enseignant non apte" |
...
| K-03 | Créer une compétition | ENSEIGNANT | Titre : Open niv2, Date : +8j, Heure : 09:00, Durée : 90, Lieu : Gymnase, Enseignant : 3, Niveau : 2 | Compétition créée |
| K-04 | Créer — enseignant non apte | ENSEIGNANT | Enseignant : 3 (niv3) pour niveau 5 | Erreur |
| K-05 | Créer — bouton absent | MEMBRE | — | Bouton "+ Nouvelle compétition" non affiché |
| K-06 | Ajouter un résultat | ENSEIGNANT | Compétition niv3, Membre : 7, Enseignant : 3, Note : 8.5 | Erreur 409 (résultat déjà existant pour ce membre) |
| K-07 | Ajouter un résultat nouveau | ENSEIGNANT | Compétition niv1, Membre : 5, Enseignant : 3, Note : 9.0 | Erreur 409 (déjà existant) — tester avec une nouvelle compétition |
| K-08 | Ajouter — membre niveau incorrect | ENSEIGNANT | Compétition niv5, Membre : 5 (niv1) | Erreur 400 niveau incompatible |
...
| B-04 | Associer un badge | SECRETAIRE | Badge : 6, Membre : 10 | Erreur 409 — membre 10 a déjà le badge 9 |
| B-05 | Associer badge disponible | SECRETAIRE | Badge : 10, Membre : 1 (président) | Badge associé, statut passe à ASSOCIE |
| B-06 | Associer badge déjà pris | SECRETAIRE | Badge : 1 (déjà associé au membre 5) | Erreur 409 badge déjà associé |
...
| # | Action | Rôle | Données de test | Résultat attendu |
|---|--------|------|-----------------|------------------|
| P-01 | Scanner un badge | Tout | Badge : 1, Cours : 2 | Présence enregistrée (badge 1 / cours 2 non encore scanné) |
| P-02 | Scanner — doublon | Tout | Badge : 1, Cours : 1 (déjà présent) | Erreur 409 "déjà scanné" |
| P-03 | Scanner — badge inexistant | Tout | Badge : 999, Cours : 1 | Erreur 404 badge introuvable |
| P-04 | Consulter par cours | ENSEIGNANT / SECRETAIRE / PRESIDENT | Cours : 8 | 3 présences (membres 7, 9, 10) |
| P-05 | Consulter par membre | ENSEIGNANT / SECRETAIRE / PRESIDENT | Membre : 9 | Présences aux cours 5, 8, 9, 10 |
...
| S-05 | Élèves présents à un cours | PRESIDENT | Saisir 8 + Entrée (loupe) dans "Élèves présents à un cours" | Tableau : 3 élèves (membres 7, 9, 10) avec badge et date de scan |
| S-06 | Cours inexistant | PRESIDENT | Saisir 999 dans le même bloc | Erreur 404 |
| S-07 | Parcours membre — cours | PRESIDENT | Saisir 9 + Entrée dans "Parcours d'un membre" | Colonne Cours : 2 cours, tous Présent |
| S-08 | Parcours membre — compétitions | PRESIDENT | Même recherche membre 9 | Colonne Compétitions : 1 résultat "Grand prix niveau 5" — 9.2/10 |
| S-09 | Parcours avec filtre période | PRESIDENT | Membre : 9, Du : il y a 35j, Au : aujourd'hui | Seulement les cours dans la période (date de filtre incluse) |
| S-10 | Membre introuvable | PRESIDENT | Saisir 999 + Entrée | Erreur affiché |
| S-11 | Input négatif bloqué | PRESIDENT | Taper -5 dans n'importe quel champ numérique | Le champ reste vide, aucun appel API |
